...
class plgSystemAutofbook2nd extends JPlugin {
    var $config;
    var $inBackend;
    var $error = false;
    var $CheckClass;
    ...
    public function plgSystemAutofbook2nd( $subject, $config ) {
        parent::__construct( $subject, $config );
        $language = JFactory::getLanguage();
        $language->load('plg_system_autofbook2nd', JPATH_ADMINISTRATOR, 'en-GB', true);
        $language->load('plg_system_autofbook2nd', JPATH_ADMINISTRATOR, null, true);
        ...
        $this->config = array(
            'shareLogTableName'     =>      '#__autofbook2nd_posted',
            'pluginLangPrefix'      =>      'PLG_SYSTEM_AUTOFBOOK_',
            'pluginElement'         =>      'autofbook2nd',
            'classFolder'           =>      'autofbook2nd'.DS.'classes',
            'articleClass'          =>      'jArticle2nd',
            'articleClassFile'      =>      'jArticle2nd.php',
            'fbookClass'            =>      'FBookClass2nd',
            'fbookClassFile'        =>      'fbookClass2nd.php',
            'jfbClass'              =>      'JFBClass2nd',
            'jfbClassFile'          =>      'jfbClass2nd.php',
            'shareControllerClass'  =>      'stlShareControllerClass2nd',
            'shareControllerFile'   =>      'stlShareControllerClass2nd.php',
            'fbControllerClass'     =>      'fbControllerClass2nd',
            'fbControllerFile'      =>      'fbControllerClass2nd.php',
        ...
        $this->classes = array(
            'jArticle2nd' => array(
                'name'=>'jArticle2nd',
                'file'=>'jArticle2nd.php'
            ),
            'FBookClass2nd' => array(
                'name'=>'FBookClass2nd',
                'file'=>'fbookClass2nd.php'
            ),
            'JFBClass2nd' => array(
                'name'=>'JFBClass2nd',
                'file'=>'jfbClass2nd.php'
            ),
            'stlShareControllerClass2nd' => array(
                'name'=>'stlShareControllerClass2nd',
                'file'=>'stlShareControllerClass2nd.php'
            ),
            'fbControllerClass2nd' => array(
                'name'=>'fbControllerClass2nd',
                'file'=>'fbControllerClass2nd.php'
            )
        );
        $this->jArticleClassNames = array(
            'com_article'       =>  'jArticle2nd',
            'com_content'       =>  'jArticle2nd',
            'com_k2'            =>  'k2Article2nd',
            'com_zoo'           =>  'zooArticle2nd',
            'com_virtuemart'    =>  'vmArticle2nd'
        );
        $this->preloadClasses();
...
//    }
    ...
    private function loadJArticleClass($article){
      $component = JRequest::getVar('option');
        if(array_key_exists($component, $this->jArticleClassNames)){
            ...
            JLoader::register( $className, dirname(__FILE__).DS.'autofbook2nd'.DS.'classes'.DS.'jArticle2nd.php');
    ...
    private function setupClasses() {
        if (JDEBUG) JError::raiseNotice( 0,__CLASS__."->".__FUNCTION__ );
        $this->CheckClass = new $this->classes['fbControllerClass2nd']['name']( 
            array(
