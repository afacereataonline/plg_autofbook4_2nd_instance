window.addEvent('domready', function(){
    ...
    var authElmnt = $(authorizeElement).innerHTML;
    ...
    var setButtonHref = function(){
        var link = 'https://www.facebook.com/dialog/oauth' + 
            ...
            $(authorizeElement).setStyle('color', "#ffffff;");
        if($(accessTokenElement).value == ''){
            $(authorizeElement).innerHTML = 'Connect to FB';
            $(authorizeElement).setStyle('background', "#ffffff url('../../../media/plg_autofbook/images/fb-connect-btn.png') no-repeat right top;");
        }else{
            $(authorizeElement).innerHTML = 'Remove FB Connection';
            $(authorizeElement).setStyle('background', "#ffffff url('../../../media/plg_autofbook/images/fb-disconnect-btn.png') no-repeat right top;");
        }
        return;
    };
